...
xkb_symbols "common" {
    ...
    key <AC06> { type[Group1]="MOD5_NAV", [       Cyrillic_er,       Cyrillic_ER, Left  ] };
    key <AC07> { type[Group1]="MOD5_NAV", [ Cyrillic_o, Cyrillic_O, Down] };
    key <AC08> { type[Group1]="MOD5_NAV", [ Cyrillic_el, Cyrillic_EL, Up] };
